              ...
              <div className="mt-6">
                ...
                <div className="overflow-x-auto rounded-xl border border-border">
                  <table className="min-w-full">
                    <thead>
                      <tr className="border-b border-border bg-muted/40 text-left text-xs font-medium text-foreground">
                        ...
                        return (
                          <tr key={s.testId}>
                            ...
                            <td className="px-4 py-3">
                              <div className="inline-flex items-center overflow-hidden rounded-md border border-primary/60">
                                <button
                                  type="button"
                                  onClick={() =>
                                    setSelected((arr) =>
                                ...
                                <input
                                  ...
                                  className="w-10 border-x border-primary/60 bg-transparent px-1 py-1 text-center text-sm outline-none"
                                />
                                <button
                                  type="button"
                                  onClick={() =>
                            ...
                            <td className="px-4 py-3">
                              <div className="flex w-32 items-center rounded-md border border-border bg-surface px-3 py-1.5">
                                <span className="mr-1 text-sm text-foreground">{"\u20B9"}</span>
                                <input
                                  value={s.price}
                                  onChange={(e) =>
                                    setSelected((arr) =>
                            ...
                            <td className="px-4 py-3">
                              <div className="relative w-28">
                                <select
                                  ...
                                  className="h-9 w-full appearance-none rounded-md border border-border bg-surface px-3 pr-8 text-sm text-muted-foreground outline-none"
                                >
                            ...
                            <td className="px-4 py-3">
                              <button
                                ...
                                className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-danger/40 text-danger hover:bg-danger-soft"
                              >
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-[1fr_280px]">
              <div>
                <div className="mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  Referring Doctor <span className="ml-1 rounded bg-muted px-1.5 py-0.5 text-[10px] font-medium">OPTIONAL</span>
                </div>
                <div className="relative">
                  <select
                    value={doctor}
                    onChange={(e) => setDoctor(e.target.value)}
                    className="h-12 w-full appearance-none rounded-xl border border-border bg-surface px-4 pr-10 text-sm outline-none"
                  >
            ...
            <div className="px-5 py-5">
              ...
              {viewMore && (
                <dl className="mt-4 text-sm">
                  <DetailRow label="Patient ID" value={<span className="text-info">{patient.id}</span>} />
          ...
          <section className="overflow-hidden rounded-2xl border border-border bg-surface">
            ...
            <div className="px-5 py-5">
                ...
                <Row
                  ...
                  value={
                    <input
                      ...
                      className="w-32 rounded-md border border-border bg-surface px-2 py-1 text-right text-sm outline-none"
                    />
                  }
                />
                <Row
              ...
              <button
                ...
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-md border border-primary py-2.5 text-sm font-semibold text-primary hover:bg-primary-soft disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={!patient || selected.length === 0}
                className="mt-3 w-full rounded-md bg-primary py-2.5 text-sm font-semibold text-primary-foreground hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
              >
                Confirm Order
              </button>
            </div>
